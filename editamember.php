...
do {  
?>
              <option value="<?php echo $row_rstuserlev['userlevelid']?>" <?php if (!(strcmp($row_rstuserlev['userlevelid'], htmlentities($row_Recordset1['userlevel'], ENT_COMPAT, 'utf-8')))) {echo "SELECTED";} ?>><?php echo $row_rstuserlev['userlevel']?></option>
              <?php
