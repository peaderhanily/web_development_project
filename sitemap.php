...
<div id="wrapper">
  ...
  <div id="innerwrapper">
    ...
    <p>| <a href="home.php">Home</a> | <a href="sitemap.php">Site map</a> |</p>
    
    <hr />
    
   <h2>Site-map</h2>
   <p>&nbsp;</p>
   <div class="sitemapcontain">
     <ul>
       <li><a href="home.php">Homepage</a></li>
       <br />      
       <li><a href="aboutus.php">About Us</a></li>
       <li><a href="regattacalender.php">Competitive</a></li>
       <li><a href="results.php">Results</a></li>
       <li><a href="otherevents.php">Club Events</a></li>
       <li><a href="limerickregatta.php">Limerick Regatta</a></li>
       <li><a href="safety.php">Safety</a></li>
       <li><a href="rowinglinks.php">Other Links</a></li>
...
<!--This is the end of the main area-->
 ...
 <li> <a href="sitemap.php" class="current" title="Sitemap">Site Map</a> </li>
